...
function basketInfo() {
 ...
 const burger__images = document.querySelectorAll('.card__img');
 butger__images.forEach(function (butger__images) {
    butger__images.addEventListener('click', function () {
         const clickedSrc = butger__images.getAttribute('src');
